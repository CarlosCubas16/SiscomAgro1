...
class DocumentoController extends Controller
{
    ...
    public function obtenerCuotas($id)
    {
        ...
        if(strtoupper($modo->simbolo) == 'CREDITO' || strtoupper($modo->simbolo) == 'CRÉDITO')
        {
            $arrayCuotas[] = array(
                "moneda" => "PEN",
                "monto" => (float)$documento->total,
                "fechaPago" => self::obtenerFechaCuota($documento)
    ...
    public function obtenerFechaCuota($documento)
    {
        $date_ = date("d-m-Y", strtotime($documento->fecha_documento . "+ 10 days"));
